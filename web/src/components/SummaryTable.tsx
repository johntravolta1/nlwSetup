...
const minimunSummaryDates = 18 * 7 //18 semanas
    ...
    return (
        <div className="w-full flex">
            <div className="grid grid-rows-7 grid-flow-row gap-3">
                {weekDays.map((w, i) => {
                    return (
                        <div key={`${w}-${i}`} className="text-zinc-400 text-xl h-10 w-10 font-bold flex items-center justify-center">{w}</div>
                    )
                })}
            </div>
