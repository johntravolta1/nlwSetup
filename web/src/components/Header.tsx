      ...
      <div className='w-full max-w-3xl mx-auto flex items-center justify-between mb-16'>
        ...
        <Dialog.Root>
          <Dialog.Trigger 
            ...
            transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background'
          >
            <Plus size={20} className='text-violet-500 hover:text-white'></Plus>
            Novo hábito
          </Dialog.Trigger >
